...
plugins=(git git-flow mvn brew osx npm)
...
PATH=/usr/local/bin:$HOME/bin:/usr/local/share/npm/bin:$PATH:$HOME/.rvm/bin # Add RVM to PATH for scripting

DHIS2_HOME=$HOME/Workspace/j2ee/dhis-2/home
